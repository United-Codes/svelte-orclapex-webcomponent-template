// go to the network tab in the developer tools and search for "wwv_flow.js_messages"
// as this is app specific, we can't load it from the CDN

export default function initAPEXlang() {
  apex.lang.addMessages({
    ...
    "APEX.SESSION.ALERT.IDLE_WARN":
      "Your session will end at \u00250. Would you like to extend it?",
    "APEX.SESSION.ALERT.MAX_WARN":
      "Your session will end at \u00250 and cannot be extended. Please save any work now to avoid losing any data",
    ...
    "APEX.SPLITTER.HORIZ_CANNOT_LEFT_RIGHT":
      "Horizontally oriented splitter cannot be moved to the left or to the right",
    ...
    "APEX.SPLITTER.VERTICAL_CANNOT_UP_DOWN":
      "Vertically oriented splitter cannot be moved up or down",
    ...
    "APEX.WF_DIAGRAM.ARIA_DESC":
      "The workflow diagram is not accessible at this time.",
    ...
    "APEX.COLOR_PICKER.INVALID_COLOR":
      "#LABEL# must be a valid color. Example: \u00250",
    "APEX.COLOR_PICKER.MORE_PRESET_COLORS": "More colors",
    "APEX.COLOR_PICKER.OPEN": "Open color picker",
    "APEX.COLOR_PICKER.SPECTRUM.ALPHA_SLIDER":
      "Alpha Slider, horizontal slider. Use arrow keys to navigate.",
    "APEX.COLOR_PICKER.SPECTRUM.COLOR_SPECTRUM":
      "Color Spectrum, 4 way slider. Use arrow keys to navigate.",
    "APEX.COLOR_PICKER.SPECTRUM.HUE_SLIDER":
      "Hue Slider, vertical slider. Use arrow keys to navigate.",
    ...
    "APEX.DATEPICKER.VALUE_INVALID":
      "#LABEL# must be a valid date, for example \u00250.",
    "APEX.DATEPICKER.VALUE_MUST_BE_BETWEEN":
      "#LABEL# must be between \u00250 and \u00251.",
    "APEX.DATEPICKER.VALUE_MUST_BE_ON_OR_AFTER":
      "#LABEL# must be on or after \u00250.",
    "APEX.DATEPICKER.VALUE_MUST_BE_ON_OR_BEFORE":
      "#LABEL# must be on or before \u00250.",
    ...
    APEXIR_HELP: "Help",
    "APEX.ICON_LIST.FIRST_COLUMN":
      "On the first column already. Column \u00250 and row \u00251",
    "APEX.ICON_LIST.FIRST_ROW":
      "On the first row already. Column \u00250 and row \u00251",
    "APEX.ICON_LIST.GRID_DIM": "Presented in \u00250 columns and \u00251 rows",
    "APEX.ICON_LIST.LAST_COLUMN":
      "On the last column already. Column \u00250 and row \u00251",
    "APEX.ICON_LIST.LAST_ROW":
      "On the last row already. Column \u00250 and row \u00251",
    ...
    "APEX.IG.CHART": "Chart",
    "APEX.IG.CHART_MAX_DATAPOINT_CNT":
      "Your query exceeds the maximum of \u00250 data points per chart. Please apply a filter to reduce the number of records in your base query.",
    ...
    "APEX.IG.COLUMN_HEADER_ACTIONS_FOR":
      "Actions for \u0022\u00250\u0022 column",
    ...
    "APEX.IG.EDIT_MODE_DESCRIPTION":
      "Grid in edit mode, un-press to switch to view mode",
    ...
    "APEX.IG.INVALID_SORT_BY":
      "Sort By has been set to \u00250, but no column as been selected for \u00250.",
    ...
    "APEX.IG.MORE_DATA_FOUND":
      "The data contains more than \u00250 rows which exceeds the maximum allowed. Please apply additional filters in order to view the results.",
    "APEX.IG.NAME": "Name",
    ...
    "APEX.IG.REPORT.SAVED.ALTERNATIVE":
      "Alternative report saved for all users",
    ...
    "APEX.IG.REPORT_DATA_AS_OF.X.MINUTES_AGO":
      "Grid data as of \u00250 minutes ago",
    ...
    "APEX.IG.SORT_ONLY_ONE_PER_COLUMN":
      "You can define only one sort per column.",
    ...
    "APEX.IG.UNIT": "Unit",
    "APEX.IG.UNSAVED_CHANGES_CONTINUE_CONFIRM":
    ...
    "APEX.IG.X.GREATER_THAN_OR_EQUALS.Y":
    ...
    "APEX.IG.X.MATCHES_REGULAR_EXPRESSION.Y":
      "\u00250 matches regular expression \u00251",
    ...
    "APEX.IG.X.NOT_IN_THE_LAST.Y.HOURS":
      "\u00250 not in the last \u00251 hours",
    "APEX.IG.X.NOT_IN_THE_LAST.Y.MINUTES":
      "\u00250 not in the last \u00251 minutes",
    "APEX.IG.X.NOT_IN_THE_LAST.Y.MONTHS":
      "\u00250 not in the last \u00251 months",
    "APEX.IG.X.NOT_IN_THE_LAST.Y.WEEKS":
      "\u00250 not in the last \u00251 weeks",
    "APEX.IG.X.NOT_IN_THE_LAST.Y.YEARS":
      "\u00250 not in the last \u00251 years",
    ...
    "APEX.IG.X.NOT_IN_THE_NEXT.Y.HOURS":
      "\u00250 not in the next \u00251 hours",
    "APEX.IG.X.NOT_IN_THE_NEXT.Y.MINUTES":
      "\u00250 not in the next \u00251 minutes",
    "APEX.IG.X.NOT_IN_THE_NEXT.Y.MONTHS":
      "\u00250 not in the next \u00251 months ",
    "APEX.IG.X.NOT_IN_THE_NEXT.Y.WEEKS":
      "\u00250 not in the next \u00251 weeks",
    "APEX.IG.X.NOT_IN_THE_NEXT.Y.YEARS":
      "\u00250 not in the next \u00251 years",
    ...
    "APEX.ITEM.FILE.ACCEPTED_TYPES":
      "Invalid file type. Supported file types \u00250.",
    ...
    "APEX.ITEM.IMAGE_UPLOAD.DROP_OR_CHOOSE_FILE":
      "Select a image or drop one here.",
    "APEX.ITEM.IMAGE_UPLOAD.DROP_OR_CHOOSE_FILES":
      "Select or drop images here.",
    "APEX.ITEM.IMAGE_UPLOAD.DROP_OR_SELECT_FILE":
      "Select a image or drop one here.",
    "APEX.ITEM.IMAGE_UPLOAD.DROP_OR_SELECT_FILES":
      "Select or drop images here.",
    ...
    "APEX.MAPS.ORACLE_MAP_COPYRIGHT":
      "\u0026copy; 2022 Oracle Corporation \u0026nbsp;\u0026nbsp; \u003Ca rel=\u0022noopener noreferrer\u0022 target=\u0022_blank\u0022 href=\u0022https:\u002F\u002Felocation.oracle.com\u002Felocation\u002Flegal.html\u0022\u003ETerms\u003C\u002Fa\u003E \u0026nbsp;\u0026nbsp; Map data \u0026copy; 2021 HERE",
    "APEX.MAPS.OSM_MAP_COPYRIGHT":
      "\u003Ca rel=\u0022noopener noreferrer\u0022 target=\u0022_blank\u0022 href=\u0022http:\u002F\u002Fopenmaptiles.org\u0022\u003E \u0026copy; OpenMapTiles \u003C\u002Fa\u003E \u0026nbsp; \u003Ca rel=\u0022noopener noreferrer\u0022 target=\u0022_blank\u0022 href=\u0022https:\u002F\u002Fwww.openstreetmap.org\u002Fcopyright\u0022\u003E \u0026copy; OpenStreetMap contributors \u003C\u002Fa\u003E",
    ...
    "APEX.NUMBER_FIELD.VALUE_GREATER_MAX_VALUE":
      "#LABEL# must be a number less than or equal to \u00250.",
    ...
    "APEX.POPUP_LOV.FILTER_REQ":
      "Enter a search term of at least \u00250 characters.",
    ...
    "F4300.DATA_UNLOAD_INITIATED":
      "File with data to be unloaded is being prepared and downloaded.",
    "DATA_LOAD.NO_PREVIEW": "No file preview available",
    "ODG.MESSAGE.INSERTED_DATA":
      "Successfully inserted data into the database.",
    "ODG.MESSAGE.INVALID_ROWS":
      "Please specify number of rows for the following tables: \u00250",
    "ODG.MESSAGE.MAX_RECORDS_TABLES":
      "You can only choose \u00250 tables to generate a blueprint (additional tables can be added afterwards).",
    "ODG.MESSAGE.SELECT_ONE_TABLE":
      "Please select at least one table to create a blueprint",
    "PE.PROPERTY.IG_DOWNLOAD_FORMATS.LOV.XLSX.D": "Excel",
    DEVELOPER_TOOLBAR_ERRORS:
    ...
    DEVELOPER_TOOLBAR_NO_BUILDER:
      "This functionality requires the Oracle APEX App Builder window to be open. Do you want to open the Builder in this window?",
    "APEX.ISSUES.ASSIGN": "Assign",
    "APEX.ISSUES.CARDS": "Cards",
    "APEX.ISSUES.DELETE": "Delete",
    "APEX.ISSUES.DELETE_COMMENT_CONFIRM":
      "Are you sure you want to delete this comment?",
    "APEX.ISSUES.DELETE_ISSUE": "Delete Issue",
    "APEX.ISSUES.DELETE_ISSUE_CONFIRM":
    ...
    "APEX.ISSUES.JS.SINGLE_TOO_LARGE":
      "too large to upload. \u003Cbr\u003EFiles must be less than",
    ...
    "GALLERY.MISSING_VALUES_ERROR":
      "Missing required information to further process installation.",
    "GALLERY.MORE_INFO": "More Info",
    "GALLERY.OPEN_NEW_WINDOW": "Opens in new window",
    "GALLERY.REMOVE_APP": "Remove",
    "GALLERY.REMOVE_APP_CONFIRM":
      "\u003Cp\u003EAre you sure you want to remove \u003Cstrong\u003E\u00250 (\u00251)\u003C\u002Fstrong\u003E?\u003C\u002Fp\u003E\u000A\u003Cp\u003EThis will uninstall the application and remove its supporting database objects.\u003C\u002Fp\u003E",
    "GALLERY.RUN_APP": "Run",
    "GALLERY.UPDATE_APP": "Update",
    "GALLERY.UPDATE_APP_CONFIRM":
      "\u003Cp\u003EAre you sure you want to update \u003Cstrong\u003E\u00250 (\u00251)\u003C\u002Fstrong\u003E?\u003C\u002Fp\u003E \u003Cp\u003EThis will uninstall the application and remove its supporting database objects before it\u0027s installed again.\u003C\u002Fp\u003E",
    ...
    "APEX.ISSUES.REPLACE_COMMENT_CONFIRM":
      "Do you want to replace your current comment with this template?",
    ...
    "CODE_EDITOR.CHAT.AI_DEBUG_MESSAGE":
      "Let me find out if I can help you with this problem...",
    "CODE_EDITOR.CHAT.APEX_ASSISTANT": "APEX Assistant",
    "CODE_EDITOR.CHAT.CLEAR_CHAT": "Clear chat",
    "CODE_EDITOR.CHAT.CONTENT_TOO_LONG":
      "The content is too long, please select the relevant code snippet before proceeding.",
    "CODE_EDITOR.CHAT.DEBUG_HELP_LABEL": "Help me fix this",
    "CODE_EDITOR.CHAT.DEBUG_MESSAGE":
      "Given your latest suggested code, and based on your role\u0027s expertise, analyze the code. Your objective is to find, give an explanation and a solution of any semantic and syntactic errors found in the code.",
    "CODE_EDITOR.CHAT.DISCLAIMER":
      "Please note that AI-generated code may contain errors or security risks. Always review and validate all code before use.",
    "CODE_EDITOR.CHAT.ERROR_CODE_MESSAGE":
      "I have the following error: \u00250",
    "CODE_EDITOR.CHAT.EXPLAIN": "Explain",
    "CODE_EDITOR.CHAT.EXPLAIN_MSG":
      "I\u0027m having trouble understanding this code block. Can you please explain it to me?",
    ...
    "CODE_EDITOR.CHAT.IMPROVE_MSG":
      "Help me improve the quality, efficiency, and security of this code block.",
    ...
    "CODE_EDITOR.CHAT.QUERY_BUILDER_WELCOME":
      "Hi there, I can help you author SQL based on tables and views in your current schema. What can I help you query?",
    "CODE_EDITOR.CHAT.QUICK_ACTION_QUESTION":
      "I see you have selected some code. How can I assist you with it?",
    "CODE_EDITOR.CHAT.USE_SELECTION": "Use selection",
    "CODE_EDITOR.CHAT.USE_THIS_WARNING":
      "You need to select something in the editor first.",
    "CODE_EDITOR.CHAT.WARNING_CODE_MESSAGE":
      "I have the following warning: \u00250",
    ...
    "APEXDEV.PE.FILTER_NO_MATCH_COMMON":
      "No results found. Try searching all properties by clicking the \u0027Show All\u0027 button above.",
    "APEXDEV.PE.FILTER_PROPERTIES": "Filter Properties",
    "APEXDEV.PE.INVALID": "\u00250 (Invalid)",
    "APEXDEV.PE.LIST_OF_VALUES": "List of Values: \u00250",
    "APEXDEV.PE.NO": "No",
    "APEXDEV.PE.NO_COMMON_PROPERTIES":
      "The selected components have no properties in common.",
    ...
    "LOGO.LABEL.CUSTOM":
      "Custom logo markup can be set in the Application Builder.",
    ...
    "APEXDEV.PE.YES": "Yes",
    "WWV_FLOW_THEME_DEV.WWV_FLOW_THEME_STYLE_UK":
      "Name is already used by an existing style!",
    "WWV_FLOW_BUILDER.REMOTESQL.CODE_COMPLETION_NOT_SUPPORTED":
      "Code completion is not supported for Remote SQL.",
    "WWV_FLOW_BUILDER.REMOTESQL.QUERY_BUILDER_NOT_SUPPORTED":
      "Query Builder is not supported for Remote SQL.",
    ...
    "UTR.CHANGE.PROMPT":
      "Changing the Theme Style will reset your unsaved changes. This operation cannot be undone. Do you want to proceed?",
    ...
    "UTR.COMMON.SET_CURRENT_WHEN_READ_ONLY_PROMPT":
      " You have made changes to a read-only theme. If you make it the current theme, your changes will be erased. Are you sure you want to proceed? ",
    ...
    "UTR.CONFIG_OUTPUT_ERROR":
      "Theme Roller must be opened and the current style must be valid to output the configuration.",
    "UTR.CONTRAST_DIALOG.TITLE": "Contrast Ratio:",
    "UTR.CONTRAST_VALIDATION.FAILED": "Failed",
    "UTR.CONTRAST_VALIDATION.LARGE_TEXT_NOTICE":
      "For text above 18pt or bold above 14pt",
    "UTR.CONTRAST_VALIDATION.MESSAGE":
      "Validations are performed according to the Web Content Accessibility Guidelines (WCAG) 2.0 in Color Contrast for normal sized fonts",
    ...
    "UTR.CUSTOM_CSS.DESCRIPTION":
      "This code will be included at the end of the stylesheet",
    "UTR.CUSTOM_CSS.WARNING":
      "This CSS code hides the Theme Roller dialog. It is not being applied to the page.",
    ...
    "UTR.ERROR.LOAD_FAILED":
      "Theme style could not be loaded. Please make sure the App Builder window is still open, and your session is valid.",
    "UTR.ERROR.SET_AS_CURRENT_FAILED":
      "The selected theme could not be used as the application\u0027s current theme!",
    "UTR.ERROR.THEME_STYLE_URL_ERROR":
      "\u00250 could not be loaded due to a source file missing. Open your browser\u0027s console for more information.",
    "UTR.ERROR.THEME_STYLE_WITH_ERRORS":
      "\u00250 could not be loaded due to a parsing error. Open your browser\u0027s console for more information.",
    "UTR.ERROR.UNSUPPORTED_STYLE":
      "This theme style doesn\u0027t support Theme Roller customization",
    "UTR.ERROR.UNSUPPORTED_THEME":
      "This theme has no theme styles. Please select a theme with theme styles to use Theme Roller.",
    ...
    "UTR.HELP": "Help",
    "UTR.HELP.P1":
      "Theme Roller enables easy customization of the user interface of your application by enabling you to pick colors and set styles for various application components. An application can have any number of theme styles defined, however, only the \u0027Current\u0027 theme style is used to display the application to end users.",
    "UTR.HELP.P2":
      "After making changes, attributes can easily be restored, either for the complete theme style by pressing the Reset button, or pressing the reset icon for the group. \u000A\u000AFor attributes that allow the selection of foreground and background colors, the check-box preceding the two color selections indicates color contrast information based on Web Content Accessibility Guidelines (WCAG) 2.0. A higher calculated contrast score indicates that the color combination is more accessible.",
    "UTR.IMPORT": "Import",
    ...
    "UTR.LOGO.CUSTOM.MESSAGE":
      "You can edit the logo markup in the Application Builder",
    "UTR.LOGO.ERROR_LOAD_FAILED":
      "Logo data could not be loaded. Please make sure the App Builder window is still open, and your session is valid.",
    "UTR.LOGO.IMAGE": "Image",
    "UTR.LOGO.IMAGE_DEFAULT_VALUE": "No Image Loaded.",
    "UTR.LOGO.IMAGE_TEXT": "Image and Text",
    "UTR.LOGO.MAX_FILESIZE_IN_KB":
      "Please select a file smaller than \u00250KB",
    "UTR.LOGO.NONE": "None",
    ...
    "UTR.RESET": "Reset",
    "UTR.RESET.PROMPT":
      "Are you sure you want to reset the CSS? All your changes will be lost. This operation cannot be undone.",
    ...
    "UTR.SET_AS_CURRENT_THEME_STYLE_SUCCESS":
      "The selected theme is now the application\u0027s current theme.",
    "UTR.SET_AS_CURRENT_WHEN_READ_ONLY.PROMPT":
      "You have made changes to a read-only theme. If you set this theme as the application\u0027s \u0022current\u0022 theme, your changes will be erased. Are you sure you want to proceed?",
    "UTR.STYLE_CHANGE.CONFIRM":
      "Your current customizations will be lost if you switch theme styles. Continue?",
    "UTR.TABS.LOGO": "Logo",
  ...
  apex.locale.init({
    language: "en",
    resources:
      "https:\u002F\u002Fstatic.oracle.com\u002Fcdn\u002Fapex\u002F24.1.5\u002Flibraries\u002Foraclejet\u002F16.0.10\u002Fjs\u002Flibs\u002Foj\u002F16.0.10\u002Fresources\u002Fnls\u002F",
    separators: { group: ",", decimal: "." },
    currency: { local: "$", iso: "USD", dual: "$" },
    calendar: {
      abbrMonthNames: [
        "Jan",
        "Feb",
